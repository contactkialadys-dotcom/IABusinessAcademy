...
Cette commande génère les fichiers statiques dans le dossier `web-build/`. Vous pouvez tester le résultat localement en utilisant un serveur HTTP simple :
...
3. Exécuter la commande de build (`npx expo export:web`)
