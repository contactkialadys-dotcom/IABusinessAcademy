...
Les fichiers compilés seront générés dans le dossier `web-build/`. Vous pouvez ensuite les déployer sur n'importe quel hébergeur statique comme Vercel, Netlify, ou GitHub Pages.
