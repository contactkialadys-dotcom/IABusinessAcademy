...
export default function GeneratorScreen() {
  ...
  // Image generator backend removed for Vercel compatibility
  ...
  const generateImage = async (promptText: string) => {
    ...
    Alert.alert(
      ...
      "Le générateur d'images IA nécessite un backend serveur qui n'est pas disponible dans cette version statique. Pour activer cette fonctionnalité, déployez le projet avec un backend (Heroku, Railway, etc.)."
    );
  };
    ...
    <ScreenContainer>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View className="flex-1 gap-6 p-6">
          ...
          {/* Error display removed - local mode only */}
          {false && (
          ...
          {/* Historique - disabled in local mode */}
          {false && (
