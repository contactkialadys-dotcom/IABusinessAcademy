...
export default function FormationsScreen() {
  ...
  const audioPrompting = useAudioPlayer(require("@/assets/audio/prompting-importance.wav"));
  const audioTutorial = useAudioPlayer(require("@/assets/audio/tutorial-photo-ia.wav"));
  const audioGemini = useAudioPlayer(require("@/assets/audio/gemini-intro.wav"));
  const audioGeminiModule = useAudioPlayer(require("@/assets/audio/photo-ia-module-gemini.wav"));
  const audioGemModule = useAudioPlayer(require("@/assets/audio/photo-ia-module-gem.wav"));
  const audioPromptsModule = useAudioPlayer(require("@/assets/audio/photo-ia-module-prompts.wav"));
  const audioEconomiesModule = useAudioPlayer(require("@/assets/audio/photo-ia-module-economies.wav"));
  
  // Audios Vidéo IA
  const audioVideoScripts = useAudioPlayer(require("@/assets/audio/video-ia-module-scripts.wav"));
  const audioVideoOutils = useAudioPlayer(require("@/assets/audio/video-ia-module-outils.wav"));
  const audioVideoViraux = useAudioPlayer(require("@/assets/audio/video-ia-module-viraux.wav"));
  const audioVideoMonetiser = useAudioPlayer(require("@/assets/audio/video-ia-module-monetiser.wav"));
  
  // Audios E-commerce
  const audioEcomOpportunite = useAudioPlayer(require("@/assets/audio/ecommerce-module-opportunite.wav"));
  const audioEcomProduits = useAudioPlayer(require("@/assets/audio/ecommerce-module-produits.wav"));
  const audioEcomBoutique = useAudioPlayer(require("@/assets/audio/ecommerce-module-boutique.wav"));
  const audioEcomPaiements = useAudioPlayer(require("@/assets/audio/ecommerce-module-paiements.wav"));
  const audioEcomLivraison = useAudioPlayer(require("@/assets/audio/ecommerce-module-livraison.wav"));
  const audioEcomFacebookAds = useAudioPlayer(require("@/assets/audio/ecommerce-module-facebook-ads.wav"));
  
  // Audios Gemini
  const audioGeminiCompte = useAudioPlayer(require("@/assets/audio/gemini-module-compte.wav"));
  const audioGeminiPrompting = useAudioPlayer(require("@/assets/audio/gemini-module-prompting.wav"));
  const audioGeminiGems = useAudioPlayer(require("@/assets/audio/gemini-module-gems.wav"));
  const audioGeminiImages = useAudioPlayer(require("@/assets/audio/gemini-module-images.wav"));
  const audioGeminiContenu = useAudioPlayer(require("@/assets/audio/gemini-module-contenu.wav"));
  const audioGeminiDonnees = useAudioPlayer(require("@/assets/audio/gemini-module-donnees.wav"));
  const audioGeminiExtensions = useAudioPlayer(require("@/assets/audio/gemini-module-extensions.wav"));
  const audioGeminiCasPratiques = useAudioPlayer(require("@/assets/audio/gemini-module-cas-pratiques.wav"));
  const audioGeminiAstuces = useAudioPlayer(require("@/assets/audio/gemini-module-astuces.wav"));
  const audioGeminiPlanAction = useAudioPlayer(require("@/assets/audio/gemini-module-plan-action.wav"));
